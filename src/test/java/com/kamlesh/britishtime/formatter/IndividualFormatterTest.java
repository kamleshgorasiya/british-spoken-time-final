...
class IndividualFormatterTest {
    ...
    void testThirtyPlusFormatter() {
        ...
        assertEquals(Optional.of("three thirty three"), formatter.tryFormat(LocalTime.of(3, 33)));
        assertEquals(Optional.of("three thirty four"), formatter.tryFormat(LocalTime.of(3, 34)));
        
        // Should not handle other minutes
        assertEquals(Optional.empty(), formatter.tryFormat(LocalTime.of(3, 30)));
        assertEquals(Optional.empty(), formatter.tryFormat(LocalTime.of(3, 35)));
        assertEquals(Optional.empty(), formatter.tryFormat(LocalTime.of(3, 40)));
    }
    ...
    void testMinutesToFormatter() {
        ...
        // Should not handle minutes <= 34
        assertEquals(Optional.empty(), formatter.tryFormat(LocalTime.of(3, 0)));
        assertEquals(Optional.empty(), formatter.tryFormat(LocalTime.of(3, 15)));
        assertEquals(Optional.empty(), formatter.tryFormat(LocalTime.of(3, 30)));
        assertEquals(Optional.empty(), formatter.tryFormat(LocalTime.of(3, 31)));
        assertEquals(Optional.empty(), formatter.tryFormat(LocalTime.of(3, 34)));
