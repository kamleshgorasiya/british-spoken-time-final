 ...
 */
class ChainedBritishTimeFormatterTest {

    private TimeSpokenFormatter formatter;

    @BeforeEach
    void setUp() {
        formatter = new ChainedBritishTimeFormatter();
    }
    ...
    void testCustomChainWithBuilder() {
        TimeSpokenFormatter customFormatter = new ChainedBritishTimeFormatter.Builder()
    ...
    void testBuilderThrowsExceptionWhenEmpty() {
        ChainedBritishTimeFormatter.Builder builder = new ChainedBritishTimeFormatter.Builder();
