 ...
 */
public abstract class AbstractTimeFormatterImpl implements TimeSpokenFormatter {

    protected AbstractTimeFormatterImpl nextFormatter;
     ...
     */
    public AbstractTimeFormatterImpl setNext(AbstractTimeFormatterImpl nextFormatter) {
